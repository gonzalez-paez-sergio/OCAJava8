 ...
 * Things to remember
 * 
 * Unless overriden with parenthesis, Java operator follow order of operation by
 * decreasing order of precedence. if 2 operators have the same level of
 * precedence then java guarantee left to right evaluation
 * 
 * 
 *
 */
